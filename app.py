...
current_style_preset = "🤝 フランクな相棒"
current_user_instruction = STYLE_PRESETS["🤝 フランクな相棒"]
current_ai_avatar = "🤖"
current_user_avatar = "💫"
            ...
            if len(user_input) > MAX_INPUT_CHARS:
                ...
                if not is_allowed:
                    ...
                    with st.spinner(f"{current_concierge_name}が言葉を紡いでいます..."):
                        ...
                        ・【寝る宣言後のツッコミルール】同じ時間帯の過去の会話で、ユーザーが「寝る」「もう寝る」「おやすみ」などを発言した後の会話で、さらに別の話題を送ってきた場合、最初の1回だけ「あれ、さっき寝るって言ってなかった？笑」のような軽いツッコミを入れてください。このルールは時間帯気遣いルールより優先します。
