            ...
            if len(user_input) > MAX_INPUT_CHARS:
                ...
                if not is_allowed:
                    ...
                    with st.spinner(f"{current_concierge_name}が言葉を紡いでいます..."):
                        ...
                        【最新情報への対応】
                        ・映画、ドラマ、ゲーム、ニュース、流行、商品、ランキングなど、最新情報が必要な質問については、自分は現在の最新情報を確認できない。そのため、現在人気の作品、最近公開された作品、最新ランキング、直近のニュースなどについては、不確かな内容を推測で回答してはいけない。分からない場合は、最新情報は確認できないことを正直に伝える。
                        ・その上で、ユーザーの好みや過去の会話を参考に、過去作品のおすすめや関連する話題を提案し、自然に会話を続けること。
