            ...
            if len(user_input) > MAX_INPUT_CHARS:
                ...
                if not is_allowed:
                    ...
                    with st.spinner(f"{current_concierge_name}が言葉を紡いでいます..."):
                        ...
                        現在の人格は反応や振る舞いを決め、応答方針は話し方や回答形式を決めます。
                        人格と応答方針は、導入文、気遣い、雑談、質問、共感、ツッコミを含む回答全体へ適用してください。
                        現在の人格や応答方針と異なる過去のAIの話し方は模倣しないでください。
                        ...
                        ・特定の作品が好きという事実は、その作品名を趣味とは断定しないでください。ただし、ドラマを頻繁に見るなど、継続的な活動が明示されている場合は「ドラマ鑑賞」のように趣味として扱って構いません。
                        ・仕事や開発プロジェクトは、本人が趣味だと明示していない限り趣味として扱わないでください。
                        ...
                        【専門作業の制限】
                        プログラムのコード記述、画像生成、長文の執筆や翻訳を依頼された場合は実行せず、現在の人格を保ちながら3行以内で丁寧に断ってください。
